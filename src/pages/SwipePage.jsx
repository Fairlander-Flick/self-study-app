...
[
  {
    ...
    "flashcards": [
      { "type": "multiple_correct", "question": "Conceptual Q?", "options": ["A) 1", "B) 2", "C) 3", "D) 4", "E) 5"], "answer": ["C) 3"], "explanation": "3 is conceptually accurate because..." },
      { "type": "multiple_correct", "question": "Q (Choose all)?", "options": ["A) 1", "B) 2", "C) 3", "D) 4", "E) 5"], "answer": ["A) 1", "D) 4"], "explanation": "1 and 4 combine to create the required effect, while the others belong to different mechanisms." }
    ]
  }
]`;
